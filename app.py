...
from routes.estado_resultado_routes import router as resultados_bp
from routes.estado_routes import router as estado_general_bp
...
app.register_blueprint(estado_general_bp)
